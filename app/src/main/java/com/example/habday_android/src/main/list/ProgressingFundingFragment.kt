...
class ProgressingFundingFragment : BaseFragment<FragmentProgressingFundingBinding>(FragmentProgressingFundingBinding::bind, R.layout.fragment_progressing_funding) {
